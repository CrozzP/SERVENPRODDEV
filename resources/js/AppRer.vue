               ...
               <div class="info">
                  <div class="nav-item "  >
                     <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                        <span>
                           {{user.name}}
                           <span class="user-level">{{userEst.puestoColaborador.puesto.nombre}}</span>
...
<script>
	...
	import Header from './components/layouts/rer/includes/Header.vue';
	import Sidebar from './components/layouts/rer/includes/Sidebar.vue';
	import Footer from './components/layouts/rer/includes/Footer.vue';
	...
	export default{
		...
		props : ['user', 'roles', 'permissions','userEst',],
