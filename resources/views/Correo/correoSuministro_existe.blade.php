...
<html>
<head>
<title>El correo ya fue validado</title>
<meta charset="UTF-8">
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  <img class="w3-image" src="/assets/img/examples/example4.jpeg" alt="Architecture" width="100%" height="50%">
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32 w3-center" id="about">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">El correo ya fue validado</h3>
