    ...
    <body>
        ...
        <div>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td colspan="2"><b>Titular : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['NombreSuministro'] }}</span></td>
                    <td colspan="2"><b>Direccion : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['DireccionPredio'] }}</span></td>
                </tr>
                <tr>
                    <td colspan="1"><b>DNI : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['Documento'] }}</span></td>
                    <td colspan="1"><b>Suministro : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['CodigoSuministro'] }}</span></td>
                    <td colspan="2"><b>Ruta : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['CodigoRutaSuministro'] }}</span></td>
                    
                    
                </tr>
                <tr>
                    <td colspan="1"><b>Departamento : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['NombreDepartamento'] }}</span></td>
                    <td colspan="1"><b>Provincia : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['NombreProvincia'] }}</span></td>
                    <td colspan="2"><b>Distrito : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['suministro']['NombreDistrito'] }}</span></td>
                </tr>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td colspan="1"><b>Apellidos y Nombres : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['persona_extraordinario']['persona']['nombres'] }}</span></td>
                    <td colspan="1"><b>DNI : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['persona_extraordinario']['persona']['dni'] }}</span></td>
                </tr>
                <tr>
                    
                    <td colspan="1"><b>Celular : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['persona_extraordinario']['persona']['telefono'] }}</span></td>
                    <td colspan="1"><b>Parentesto : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['persona_extraordinario']['persona']['email'] }}</span></td>
                </tr>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td colspan="1"><b>Tipo de Registro : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['obs_tipo_extraordinario']['tipo_extraordinario']['nombreTipoExt'] }}</span></td>
                    <td colspan="1"><b>Estado : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['obs_tipo_extraordinario']['tipo_extraordinario']['estado'] }}</span></td>
                ...
                <tr>
                    <td colspan="2"><b>Descripcion : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['obs_tipo_extraordinario']['descripcion'] }}</span></td>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td colspan="2"><b>Apellidos y Nombres : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['persona_extraordinario']['persona']['nombres'] }}</span></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2"><b>DNI : </b><span style="text-transform: uppercase!important;">{{ $reporte->estado_extraordinario['extraordinario']['persona_extraordinario']['persona']['dni'] }}</span></td>
                </tr>
