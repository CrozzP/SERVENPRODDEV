...
<body>
  <div>
	...
	<h2>FORMATO DE REGISTRO DE REPORTE SERVICIO DE REPARACIONES - RECONEXIONES</h2>
...
<h3 style="background-color:#1e63f5;color:white; text-align: center; ">Electro Puno S.A.A. - Formato Horizontal</h3>
<table>
  <tr style="background-color:#3ca7ff;color:black; text-align: center; ">
    ...
    <tr>
      <td style=" border-bottom: 1.2px solid #1967e1">1</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->created_at}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->obsTipoExtraordinario->tipoExtraordinario->nombreTipoExt}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->NombreZonaAdministrativa}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->CodigoSuministro}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->CodigoRutaSuministro}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->Longitud}}, {{$extraordinarios->suministro->Latitud}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->DireccionPredio}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->NombreSuministro}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->personaExtraordinario->persona->nombre}} {{$extraordinarios->personaExtraordinario->persona->apellPat}} {{$extraordinarios->personaExtraordinario->persona->apellMat}}</td>
          
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->personaExtraordinario->persona->telefono}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->estadoExtraordinario->referencia}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->SerieMedidor}}</td>
          <td style=" border-bottom: 1.2px solid #1967e1">{{$extraordinarios->suministro->NombreTipoSistema}}</td>
